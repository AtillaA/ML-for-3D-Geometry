...
def signed_distance_atom(x, y, z):
    ...
    # proton is at the center of the orbit so center coordinates of the proton is the same as center coordinates of the orbit
    ...
    # returning minimum values of multi-dimensional arrays to output SDF values
